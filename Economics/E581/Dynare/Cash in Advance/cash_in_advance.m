...
options_ = [];
M_.fname = 'cash_in_advance';
%
% Some global variables initialization
%
global_initialization;
diary off;
logname_ = 'cash_in_advance.log';
...
options_.bytecode=0;
options_.use_dll=0;
erase_compiled_function('cash_in_advance_static');
erase_compiled_function('cash_in_advance_dynamic');
...
oo_.steady_state( 1 ) = 1.5;
oo_.steady_state( 2 ) = 5.5;
oo_.steady_state( 3 ) = 1.5;
oo_.steady_state( 4 ) = 1.5;
oo_.steady_state( 5 ) = 1.5;
oo_.steady_state( 6 ) = 1.5;
oo_.steady_state( 7 ) = 1.5;
oo_.steady_state( 8 ) = 1.5;
oo_.steady_state( 9 ) = 1.5;
oo_.steady_state( 10 ) = 1.5;
oo_.steady_state( 11 ) = 0.01;
...
save('cash_in_advance_results.mat', 'oo_', 'M_', 'options_');
